...
const Layout = ({children})=>{
    ...
    const {auth} = useSelector(response=>response);
            ...
            <div className="bg-slate-900 flex justify-around items-center">
                            ...
                            <>
                                {
                                    ...
                                    <li key={index} className="p-6 hover:bg-indigo-600">
                                        <Link className="text-white capitalize" to={item.to}>{item.label}</Link>
                                    </li>
                                }
                            </>
                        ))
                ...
                </ul>
                {
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-white shadow-lg flex flex-col absolute top-16">
                            ...
                            <button onClick={()=>dispatch(logout())} className="px-4 py-2 hover:bg-indigo-600 hover:text-white text-left">Logout</button>
                        </div>
                    </div>
                }
            </div>
